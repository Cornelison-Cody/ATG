...
ATG-funded closed-beta eligibility is explicit through `ATG_MANAGED_AI_BETA_ALLOWLIST`. See [docs/managed-ai-operations.md](docs/managed-ai-operations.md) for the OpenAI project, secret-handling, smoke-test, rotation, revocation, and reconciliation runbook.
