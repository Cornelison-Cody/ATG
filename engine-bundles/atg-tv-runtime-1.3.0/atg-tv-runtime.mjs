...
import { createAtgGameplay } from "./atg-gameplay.mjs";
import { createAtgAudioManager } from "./atg-audio.mjs";
...
async function mountRuntime(target) {
  ...
  function releaseRenderer() {
    ...
    target.app = null;
    target.gameplay?.destroy();
    target.gameplay = null;
    target.audio?.destroy();
    target.audio = null;
  ...
  try {
    ...
    target.audio = createAtgAudioManager({ sound, surface });
    target.gameplay = createAtgGameplay({ app, audio: target.audio, bridge: target.bridge, PIXI });
    target.PIXI = PIXI;
